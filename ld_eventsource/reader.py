...
from typing import Callable, Iterable, Optional, AsyncIterator


class _AIOBufferedLineReader:
    """
    ...
    """
    @staticmethod
    async def lines_from(chunks: AsyncIterator[bytes]):
        """
...
class _AIOSSEReader:
    ...
    @property
    async def events_and_comments(self):
        event_type = ""
        event_data = None
        event_id = None
